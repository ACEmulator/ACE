...
- Fully portable launcher-managed MariaDB initialization, tied to a supported and licensed MariaDB distribution.
...
- Improve managed MariaDB graceful shutdown through a distribution-supported administrative control channel.
