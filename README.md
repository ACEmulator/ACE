...
* Install Visual Studio 2017
  ...
  - If using Visual Studio Community Edition, makes sure the following two workloads are installed: .NET Core cross-platform development and .NET Desktop Development
* Install MySQL
