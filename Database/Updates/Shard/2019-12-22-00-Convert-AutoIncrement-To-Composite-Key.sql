...
ALTER TABLE `ace_shard`.`biota_properties_book` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
...
ALTER TABLE `ace_shard`.`biota_properties_bool` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
ADD PRIMARY KEY (`object_Id`, `type`),
...
ALTER TABLE `ace_shard`.`biota_properties_d_i_d` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
ADD PRIMARY KEY (`object_Id`, `type`),
...
ALTER TABLE `ace_shard`.`biota_properties_event_filter` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
...
ALTER TABLE `ace_shard`.`biota_properties_float` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
ADD PRIMARY KEY (`object_Id`, `type`),
...
ALTER TABLE `ace_shard`.`biota_properties_i_i_d` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
ADD PRIMARY KEY (`object_Id`, `type`),
...
ALTER TABLE `ace_shard`.`biota_properties_int64` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
ADD PRIMARY KEY (`object_Id`, `type`),
...
ALTER TABLE `ace_shard`.`biota_properties_skill` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
ADD PRIMARY KEY (`object_Id`, `type`),
...
ALTER TABLE `ace_shard`.`biota_properties_spell_book` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
...
ALTER TABLE `ace_shard`.`biota_properties_string` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
ADD PRIMARY KEY (`object_Id`, `type`),
...
ALTER TABLE `ace_shard`.`character_properties_fill_comp_book` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
...
ALTER TABLE `ace_shard`.`character_properties_quest_registry` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
...
ALTER TABLE `ace_shard`.`character_properties_title_book` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
...
ALTER TABLE `ace_shard`.`house_permission` 
DROP COLUMN `id`,
DROP PRIMARY KEY,
