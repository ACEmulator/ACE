...
VALUES (51724, 'ace51724-discorporaterynthidofblindrage', 10, '2020-10-21 21:40:22') /* Creature */;
...
VALUES (51724,   1,         16) /* ItemType - Creature */
     ...
     , (51724,  25,        200) /* Level */
     , (51724,  65,          1) /* Placement - RightHandCombat */
...
VALUES (51724,   1,   5) /* HeartbeatInterval */
     ...
     , (51724,  14, 1.0) /* ArmorModVsPierce */
     , (51724,  15, 1.0) /* ArmorModVsBludgeon */
     , (51724,  16, 1.0) /* ArmorModVsCold */
     , (51724,  17, 0.8) /* ArmorModVsFire */
     , (51724,  18, 0.8) /* ArmorModVsAcid */
     , (51724,  19, 1.0) /* ArmorModVsElectric */
     ...
     , (51724, 165, 1.0) /* ArmorModVsNether */
     , (51724, 166, 1.0) /* ResistNether */;
...
VALUES (51724,   1,   33561550) /* Setup */
     ...
     , (51724,   7,  268437588) /* ClothingBase */
     , (51724,   8,  100667943) /* Icon */
     , (51724,  22,  872415443) /* PhysicsEffectTable */
     , (51724,  30,         84) /* PhysicsScript - BreatheFlame */
     , (51724,  35,       1000) /* DeathTreasureType - Loot Tier: 8 */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (51724, 8040, 758186021, 111.819, 110.293, 132.029, -0.6345, 0, 0, -0.772923) /* PCAPRecordedLocation */
/* @teleloc 0x2D310025 [111.819000 110.292999 132.029007] -0.634500 0.000000 0.000000 -0.772923 */;
...
VALUES (51724,  6, 0, 2, 0, 550, 0, 0) /* MeleeDefense        Trained */
     ...
     , (51724, 15, 0, 2, 0, 350, 0, 0) /* MagicDefense        Trained */
     , (51724, 16, 0, 2, 0, 380, 0, 0) /* ManaConversion      Trained */
     , (51724, 31, 0, 2, 0, 380, 0, 0) /* CreatureEnchantment Trained */
     , (51724, 33, 0, 2, 0, 380, 0, 0) /* LifeMagic           Trained */
     , (51724, 34, 0, 2, 0, 380, 0, 0) /* WarMagic            Trained */
     , (51724, 41, 0, 2, 0, 460, 0, 0) /* TwoHandedCombat     Trained */
     , (51724, 43, 0, 2, 0, 380, 0, 0) /* VoidMagic           Trained */
     , (51724, 44, 0, 2, 0, 460, 0, 0) /* HeavyWeapons        Trained */
     , (51724, 45, 0, 2, 0, 460, 0, 0) /* LightWeapons        Trained */
     , (51724, 46, 0, 2, 0, 460, 0, 0) /* FinesseWeapons      Trained */;

INSERT INTO `weenie_properties_body_part` (`object_Id`, `key`, `d_Type`, `d_Val`, `d_Var`, `base_Armor`, `armor_Vs_Slash`, `armor_Vs_Pierce`, `armor_Vs_Bludgeon`, `armor_Vs_Cold`, `armor_Vs_Fire`, `armor_Vs_Acid`, `armor_Vs_Electric`, `armor_Vs_Nether`, `b_h`, `h_l_f`, `m_l_f`, `l_l_f`, `h_r_f`, `m_r_f`, `l_r_f`, `h_l_b`, `m_l_b`, `l_l_b`, `h_r_b`, `m_r_b`, `l_r_b`)
VALUES (51724,  0, 16,  0,    0, 550, 520, 520, 520, 520, 520, 520, 520,  600, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     , (51724,  1, 16,  0,    0, 550, 520, 520, 520, 520, 520, 520, 520,  600, 2, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest */
     , (51724,  2, 16,  0,    0, 550, 520, 520, 520, 520, 520, 520, 520,  600, 3,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0,    0, 0.17,    0) /* Abdomen */
     , (51724,  3, 16,  0,    0, 550, 520, 520, 520, 520, 520, 520, 520,  600, 1, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm */
     , (51724,  4, 16,  0,    0, 550, 520, 520, 520, 520, 520, 520, 520,  600, 2,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0,    0,  0.3,    0) /* LowerArm */
     , (51724,  5, 16, 270, 0.5, 550, 520, 520, 520, 520, 520, 520, 520,  600, 2,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0,    0, 0.12,    0) /* Hand */
     , (51724,  6, 16,  0,    0, 550, 520, 520, 520, 520, 520, 520, 520,  600, 3,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18,    0, 0.13, 0.18) /* UpperLeg */
     , (51724,  7, 16,  0,    0, 550, 520, 520, 520, 520, 520, 520, 520,  600, 3,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6,    0,    0,  0.6) /* LowerLeg */
     , (51724,  8, 16, 270, 0.5, 550, 520, 520, 520, 520, 520, 520, 520,  600, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;
