...
VALUES (4200084, 'portaltccratervillage', 7, '2022-01-25 10:00:00') /* Podtide's Town Master's Portal to Ayan Baqur */;
...
VALUES (4200084,   1,      65536) /* ItemType - Portal */
     ...
     , (4200084, 111,          48) /* idk blocked or sth ask tindale -- plus ev thinks its untieable unrecallable unsummonable but hes an idiot */
...
VALUES (4200084,  54,    -0.1) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (4200084,   1, 'Crater Village') /* Name --*/;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (4200084,   1, 0x020001B3) /* Setup */
     , (4200084,   2, 0x09000003) /* MotionTable */
     , (4200084,   8, 0x0600106B) /* Icon */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (4200084, 2, 0x90D00107, 95.521, 84, 277.3, -0.707107, 0, 0, -0.707107) /* Destination */
