...
"C:\Program Files\MySql\MySQL Server 5.7\bin\mysql.exe" -h localhost -u root -pPassword12! ace_character < database\Updates\01_2017_04_26_CharacterLastUpdate.sql
