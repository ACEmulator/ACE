...
appveyor DownloadFile https://github.com/ACEmulator/ACE-World/releases/download/v0.3.0/ACE-World-db-v0.3.0.sql.zip
7z x ACE-World-db-v0.3.0.sql.zip
"C:\Program Files\MySql\MySQL Server 5.7\bin\mysql.exe" -h localhost -u root -pPassword12! ace_world < ACE-World-db-v0.3.0.sql
