...
namespace ACE.Server.Mods
{
    public static class ModHelpers
    {
        ...
        public static void RegisterAllCommands(this ModContainer container, bool overrides = true)
        {
            ...
            var types = container.ModAssembly.GetTypes().ToArray();
        ...
        public static void RegisterUncategorizedCommands(this ModContainer container, bool overrides = true)
        {
            ...
            var types = container.ModAssembly.GetTypes().Where(t => !Attribute.IsDefined(t, typeof(CommandCategoryAttribute))).ToArray();
            RegisterCommands(container, types, overrides);
        }
        /// <summary>
        ...
        public static void RegisterCommandCategory(this ModContainer container, string categoryPattern, bool overrides = true)
        {
            ...
            try
            {
                ...
                var types = container.ModAssembly.GetTypes().Where(t => pattern.IsMatch(t.GetCustomAttribute<CommandCategoryAttribute>()?.Category)).ToArray();
                RegisterCommands(container, types, overrides);
            }
        ...
        /// </summary>
        public static void RegisterCommands(this ModContainer container, Type[] types, bool overrides = true)
        {
        ...
        /// </summary>
        public static void UnregisterCommands(this ModContainer container, Type[] types, bool overrides = true)
        {
            if (container?.ModAssembly is null)
                return;
