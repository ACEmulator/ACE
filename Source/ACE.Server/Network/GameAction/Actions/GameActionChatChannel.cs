                ...
                case Channel.Fellow:
                    {
                        ...
                        foreach (var fellowmember in fellowshipMembers.Values)
                            if (fellowmember.Session != session && !fellowmember.SquelchManager.Squelches.Contains(session.Player))
                ...
                case Channel.Vassals:
                    {
                        ...
                        foreach (var vassalGuid in session.Player.AllegianceNode.Vassals.Keys)
                        {
                            ...
                            if (vassalPlayer != null && !vassalPlayer.SquelchManager.Squelches.Contains(session.Player))
                ...
                case Channel.Patron:
                    {
                        ...
                        if (patronPlayer != null && !patronPlayer.SquelchManager.Squelches.Contains(session.Player))
                ...
                case Channel.Monarch:
                    {
                        ...
                        if (monarchPlayer != null && !monarchPlayer.SquelchManager.Squelches.Contains(session.Player))
                ...
                case Channel.CoVassals:
                    {
                        ...
                        foreach (var covassalGuid in session.Player.AllegianceNode.Patron.Vassals.Keys)
                        {
                            ...
                            else
                            {
                                ...
                                if (covassalPlayer != null && !covassalPlayer.SquelchManager.Squelches.Contains(session.Player))
                ...
                case Channel.AllegianceBroadcast:
                    {
                        ...
                        foreach (var member in player.Allegiance.Members.Keys)
                        {
                            ...
                            if (online == null || online.SquelchManager.Squelches.Contains(session.Player))
                                continue;
