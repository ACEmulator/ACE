...
namespace ACE.Server.Network.Handlers
{
    public static class AuthenticationHandler
    {
        ...
        private static void SendConnectResponse(Session session, List<Character> characters)
        {
            ...
            GameMessageServerName serverNameMessage = new GameMessageServerName(ConfigManager.Config.Server.WorldName, WorldManager.GetAllOnline().Count, (int)ConfigManager.Config.Server.Network.MaximumAllowedSessions);
