...
namespace ACE.Server
{
    partial class Program
    {
        ...
        private static void AutoApplyDatabaseUpdates()
        {
            ...
            PatchDatabase("PKKills", ConfigManager.Config.MySql.PKKills.Host, ConfigManager.Config.MySql.PKKills.Port, ConfigManager.Config.MySql.PKKills.Username, ConfigManager.Config.MySql.PKKills.Password, ConfigManager.Config.MySql.PKKills.Database, ConfigManager.Config.MySql.Shard.Database, ConfigManager.Config.MySql.World.Database);
