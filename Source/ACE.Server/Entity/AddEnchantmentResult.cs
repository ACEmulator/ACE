...
namespace ACE.Server.Entity
{
    ...
    public class AddEnchantmentResult
    {
        ...
        public void BuildStack(List<PropertiesEnchantmentRegistry> entries, Spell spell, WorldObject caster, bool equip = false, bool fromWeapon = false)
        {
            ...
            foreach (var entry in entries.OrderByDescending(i => i.PowerLevel))
            {
                ...
                else if (powerLevel == entry.PowerLevel)
                {
                    ...
                    else
                    {
                        ...
                        if (!equip && caster is Player player && player.AugmentationIncreasedSpellDuration > 0 && !fromWeapon)
