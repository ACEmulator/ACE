    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<bool>> DefaultBooleanProperties =
            DictOf(
                ...
                ("item_dispel", new Property<bool>(false, "if enabled, allows player item dispels to target items. defaults to end of retail, where item dispels could only target creatures")),
