    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<bool>> DefaultBooleanProperties =
            DictOf(
                ...
                ("allow_door_hold", new Property<bool>(true, "enables the retail issue where standing on a door while it is closing keeps the door as ethereal until it is free from collisions")),
