    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<bool>> DefaultBooleanProperties =
            DictOf(
                ...
                ("spell_requires_spell_comps", new Property<bool>(true, "if FALSE players casting spells does not require spell components in inventory. defaults to enabled, as in retail")),
