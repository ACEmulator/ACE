    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<long>> DefaultLongProperties =
            DictOf(
                ...
                ("dragon_coin_rate", new Property<long>(1, "droprate = rate * chance (d = r*c) (1 in 800 = 1 * 0.00125")),
                ("fellowship_even_share_level", new Property<long>(50, "level when fellowship XP sharing is no longer restricted")),
                ("fellowship_max_share_dist", new Property<long>(1, "determines the max share distance for fellowship kt exp and lum")),
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("dragon_coin_chance", new Property<double>(0.00125, "drop rate = dragon_coin_rate * dragon_coin_chance. So d=r*c means ( 1 * 0.00125 = 1 in 800 chance )")),
                ...
                ("kill_xp_modifier", new Property<double>(1.0, "Scales the amount of xp received by players server wide for hunting spcifically. This value can be increade by players in game contributing to a community wide event quest.")),
                ("kill_xp_modifier_max", new Property<double>(2.0, "The maximum value that kill_xp_modifier can be set to by in game NPCs via custom emote 9003.")),
                ("luminance_modifier", new Property<double>(5.0, "Scales the amount of luminance received by players")),
                ("luminance_modifier_max", new Property<double>(2.0, "The maximum value that luminance_modifier can be set to by in game NPCs via custom emote 9005.")),
                ...
                ("quest_lum_modifier_max", new Property<double>(2.0, "The maximum value that luminance_modifier can be set to by in game NPCs via custom emote 9006.")),
                ("quest_mindelta_rate", new Property<double>(1.0, "scales all quest min delta time between solves, 1 being normal")),
                ("quest_xp_modifier", new Property<double>(5.0, "Scale multiplier for amount of quest XP received by players.  Quest XP is also modified by 'xp_modifier'.")),
                ("quest_xp_modifier_max", new Property<double>(10.0, "The maximum value that luminance_modifier can be set to by in game NPCs via custom emote 9004.")),
        ...
        public static readonly ReadOnlyDictionary<string, Property<string>> DefaultStringProperties =
            DictOf(
                ...
                ("level_1000_first", new Property<string>("Asheron", "This player hit level 1000 and was in the top 10 first to do so on the server")),
                ("level_1000_second", new Property<string>("Asheron", "This player hit level 1000 and was in the top 10 first to do so on the server")),
                ("level_1000_third", new Property<string>("Asheron", "This player hit level 1000 and was in the top 10 first to do so on the server")),
                ("level_1000_fourth", new Property<string>("Asheron", "This player hit level 1000 and was in the top 10 first to do so on the server")),
                ("level_1000_fifth", new Property<string>("Asheron", "This player hit level 1000 and was in the top 10 first to do so on the server")),
                ("level_1000_sixth", new Property<string>("Asheron", "This player hit level 1000 and was in the top 10 first to do so on the server")),
                ("level_1000_seventh", new Property<string>("Asheron", "This player hit level 1000 and was in the top 10 first to do so on the server")),
                ("level_1000_eighth", new Property<string>("Asheron", "This player hit level 1000 and was in the top 10 first to do so on the server")),
                ("level_1000_nineth", new Property<string>("Asheron", "This player hit level 1000 and was in the top 10 first to do so on the server")),
                ("level_1000_tenth", new Property<string>("Asheron", "This player hit level 1000 and was in the top 10 first to do so on the server")),
