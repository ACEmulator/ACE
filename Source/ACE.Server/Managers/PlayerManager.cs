    ...
    public static class PlayerManager
    {
        ...
        public static void BootAllPlayers()
        {
            foreach (var player in GetAllOnline().Where(p => p.Session.AccessLevel < AccessLevel.Advocate))
                player.Session.Terminate(SessionTerminationReason.WorldClosed, new GameMessageBootAccount(player.Session, "\nThe world is now closed"), null, "The world is now closed");
        }
