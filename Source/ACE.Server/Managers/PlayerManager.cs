...
namespace ACE.Server.Managers
{
    public static class PlayerManager
    {
        ...
        public static bool GagPlayer(Player issuer, string playerName)
        {
            ...
            player.SetProperty(ACE.Entity.Enum.Properties.PropertyFloat.GagDuration, 31557600);

            player.SaveBiotaToDatabase();

            BroadcastToAuditChannel(issuer, $"{issuer.Name} has gagged {player.Name} indefinitely.");
