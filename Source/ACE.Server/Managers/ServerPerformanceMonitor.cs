...
namespace ACE.Server.Managers
{
    public static class ServerPerformanceMonitor
    {
        ...
        public enum CumulativeEventHistoryType
        {
            ...
            Player_Tick_UpdatePlayerPhysics,
        ...
        public new static string ToString()
        {
            ...
            for (int i = (int)CumulativeEventHistoryType.Player_Tick_UpdatePlayerPhysics; i <= (int)CumulativeEventHistoryType.WorldObject_Tick_UpdateObjectPhysics; i++)
