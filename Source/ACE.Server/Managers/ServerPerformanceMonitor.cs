...
namespace ACE.Server.Managers
{
    public static class ServerPerformanceMonitor
    {
        ...
        public enum MonitorType
        {
            ...
            UpdateGameWorld_LandblockManager_TickPhysics,
            UpdateGameWorld_LandblockManager_Tick,
        ...
        public new static string ToString()
        {
            ...
            for (int i = (int)MonitorType.UpdateGameWorld_LandblockManager_TickPhysics; i <= (int)MonitorType.UpdateGameWorld_LandblockManager_Tick; i++)
                AddMonitorOutputToStringBuilder(monitors5m[i], monitors1h[i], monitors24h[i], (MonitorType)i, sb);
