...
namespace ACE.Server.WorldObjects
{
    public class AttributeTransferDevice : WorldObject
    {
        ...
        /// </summary>
        public AttributeTransferDevice(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public AttributeTransferDevice(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
