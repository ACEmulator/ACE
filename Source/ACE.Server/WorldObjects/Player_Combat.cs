...
namespace ACE.Server.WorldObjects
{
    ...
    partial class Player
    {
        ...
        public WorldObject HandArmor => EquippedObjects.Values.FirstOrDefault(i => ((i.ClothingPriority ?? 0) & CoverageMask.Hands) != 0);

        public WorldObject FootArmor => EquippedObjects.Values.FirstOrDefault(i => ((i.ClothingPriority ?? 0) & CoverageMask.Feet) != 0);
    }
}
