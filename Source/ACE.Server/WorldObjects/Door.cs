...
namespace ACE.Server.WorldObjects
{
    public class Door : WorldObject, Lock
    {
        ...
        /// </summary>
        public Door(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public Door(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public Door(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
