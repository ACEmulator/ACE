...
namespace ACE.Server.WorldObjects
{
    ...
    public class Game : WorldObject
    {
        ...
        /// </summary>
        public Game(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public Game(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public Game(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
