...
namespace ACE.Server.WorldObjects
{
    public class Storage : Chest
    {
        ...
        /// </summary>
        public Storage(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public Storage(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public Storage(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
