...
namespace ACE.Server.WorldObjects
{
    public class Gem : Stackable
    {
        ...
        /// </summary>
        public Gem(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public Gem(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public Gem(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
