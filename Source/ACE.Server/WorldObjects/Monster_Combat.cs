...
namespace ACE.Server.WorldObjects
{
    partial class Creature
    {
        ...
        {
            return IsMeleeRange() && LastMeleeTime + MeleeDelay <= Timer.CurrentTime;
        }
        ...
        {
            LastMeleeTime = Timer.CurrentTime;
        ...
        /// <summary>
        /// Calculates the player damage for a monster attack
        /// </summary>
