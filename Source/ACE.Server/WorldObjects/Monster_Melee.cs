...
namespace ACE.Server.WorldObjects
{
    partial class Creature
    {
        ...
        public float GetArmorMod(DamageType damageType, List<WorldObject> armors, WorldObject damageSource, bool ignoreMagicResist, bool ignoreMagicArmor, float armorRendingMod = 1.0f)
        {
            var effectiveAL = 0.0f;

            foreach (var armor in armors)
                effectiveAL += GetArmorMod(armor, damageSource, damageType, ignoreMagicArmor);
        ...
        public float GetArmorMod(WorldObject armor, WorldObject damageSource, DamageType damageType, bool ignoreMagicArmor)
        {
