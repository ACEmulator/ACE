...
namespace ACE.Server.WorldObjects
{
    partial class Creature
    {
        ...
        public float MeleeAttack()
        {
            ...
            var meleeDelay = Common.Random.RollDice(MeleeDelayMin, MeleeDelayMax);
        ...
        public CombatManeuver GetCombatManeuver()
        {
            ...
            while (true)    // limiter?
            {
                var rng = Common.Random.RollDice(0, stanceManeuvers.Count - 1);
        ...
        public float CalculateDamage(ref DamageType damageType, CombatManeuver maneuver, BodyPart bodyPart, ref bool criticalHit, ref float shieldMod)
        {
            ...
            var baseDamage = Common.Random.RollDice(damageRange.Min, damageRange.Max);
        ...
        public BiotaPropertiesBodyPart GetAttackPart(CombatManeuver maneuver)
        {
            ...
            var part = parts[Common.Random.RollDice(0, parts.Count - 1)];
