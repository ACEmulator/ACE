...
namespace ACE.Server.WorldObjects
{
    partial class Player
    {
        ...
        public void CreatePlayerSpell(WorldObject target, TargetCategory targetCategory, uint spellId)
        {
            ...
            {
                // roll each time?
                var timeLimit = Common.ThreadSafeRandom.Next(3.0f, 5.0f);
        ...
        public void CreatePlayerSpell(uint spellId)
        {
            ...
            if ((Common.ThreadSafeRandom.Next(0.0f, 1.0f) > (1.0f - SkillCheck.GetMagicSkillChance((int)magicSkill, (int)spell.Power)))
