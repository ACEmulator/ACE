...
namespace ACE.Server.WorldObjects
{
    public class Stackable : WorldObject
    {
        ...
        /// </summary>
        public Stackable(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public Stackable(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public Stackable(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
