...
namespace ACE.Server.WorldObjects
{
    partial class WorldObject
    {
            ...
            switch (spell.MetaSpellType)
            {
                ...
                case SpellType.FellowEnchantment:
                    ...
                    if (itemCaster != null && (equip || itemCaster is Gem || itemCaster is Food))
                        ...
                        CreateEnchantment(targetCreature ?? target, this, this, spell, equip, fromWeapon: isWeaponSpell);
        ...
        /// </summary>
        public void CreateEnchantment(WorldObject target, WorldObject caster, WorldObject weapon, Spell spell, bool equip = false, bool fromProc = false, bool fromWeapon = false)
        {
            ...
            // create enchantment
            var addResult = target.EnchantmentManager.Add(spell, caster, weapon, equip, fromWeapon);
