...
namespace ACE.Server.WorldObjects
{
    partial class Player
    {
        ...
        public void SwearAllegiance(uint targetGuid, bool success, bool confirmed = false)
        {
            ...
            log.Debug($"{Name} swearing allegiance to {patron.Name}");
        ...
        public void HandleActionBreakAllegiance(uint targetGuid)
        {
            ...
            log.Debug(Name + " breaking allegiance to " + target.Name);
        ...
        {
            log.Debug($"{Name}.HandleActionBreakAllegianceBoot({playerName}, {accountBoot})");
