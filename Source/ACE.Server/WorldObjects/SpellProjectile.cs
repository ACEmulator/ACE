...
namespace ACE.Server.WorldObjects
{
    public class SpellProjectile : WorldObject
    {
        ...
        /// </summary>
        public SpellProjectile(Database.Models.World.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public SpellProjectile(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
