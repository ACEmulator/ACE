...
namespace ACE.Server.WorldObjects
{
    public class Switch : WorldObject
    {
        ...
        /// </summary>
        public Switch(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public Switch(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public Switch(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
