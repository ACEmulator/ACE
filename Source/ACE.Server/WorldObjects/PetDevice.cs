...
namespace ACE.Server.WorldObjects
{
    ...
    public class PetDevice : WorldObject
    {
        ...
        /// </summary>
        public PetDevice(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        ...
        /// </summary>
        public PetDevice(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public PetDevice(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
