    ...
    public partial class Player : Creature, IPlayer
    {
        ...
        public void HandleAdminvisionToggle(int choice)
        {
            ...
            if (Adminvision && oldState != Adminvision)
            {
                ...
                var nodrawObjs = PhysicsObj.ObjMaint.KnownObjects.Values.Where(o => o.WeenieObj.WorldObject != null && ((o.WeenieObj.WorldObject.NoDraw ?? false) || (o.WeenieObj.WorldObject.UiHidden ?? false)));
