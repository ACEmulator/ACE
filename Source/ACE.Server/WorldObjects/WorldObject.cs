...
namespace ACE.Server.WorldObjects
{
    ...
    public abstract partial class WorldObject : IActor
    {
        ...
        public void Destroy(bool raiseNotifyOfDestructionEvent = true, bool fromLandblockUnload = false)
        {
            ...
            if (Stuck || (ValidLocations < EquipMask.HeadWear) || (Container?.Guid.IsStatic() ?? false) || (!Wielder?.Guid.IsPlayer() ?? false) || (Container is Corpse && !Container.Level.HasValue) || (Generator is not null) || (this is Missile))
            {
