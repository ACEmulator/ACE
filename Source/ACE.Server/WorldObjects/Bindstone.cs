...
namespace ACE.Server.WorldObjects
{
    public class Bindstone : WorldObject
    {
        ...
        /// </summary>
        public Bindstone(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public Bindstone(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public Bindstone(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
