...
namespace ACE.Server.WorldObjects
{
    public class Lifestone : WorldObject
    {
        ...
        /// </summary>
        public Lifestone(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public Lifestone(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public Lifestone(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
