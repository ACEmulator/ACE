...
namespace ACE.Server.WorldObjects
{
    public class Scroll : WorldObject
    {
        ...
        /// </summary>
        public Scroll(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public Scroll(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public Scroll(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
