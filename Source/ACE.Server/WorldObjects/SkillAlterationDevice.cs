...
namespace ACE.Server.WorldObjects
{
    public class SkillAlterationDevice : WorldObject
    {
        ...
        /// </summary>
        public SkillAlterationDevice(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public SkillAlterationDevice(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public SkillAlterationDevice(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
