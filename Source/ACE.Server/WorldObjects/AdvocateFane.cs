...
namespace ACE.Server.WorldObjects
{
    public class AdvocateFane : WorldObject
    {
        ...
        /// </summary>
        public AdvocateFane(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public AdvocateFane(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public AdvocateFane(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
