...
namespace ACE.Server.WorldObjects
{
    public class Hooker : WorldObject
    {
        ...
        /// </summary>
        public Hooker(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public Hooker(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public Hooker(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
