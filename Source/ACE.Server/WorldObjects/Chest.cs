...
namespace ACE.Server.WorldObjects
{
    public partial class Chest : Container, Lock
    {
        ...
        /// </summary>
        public Chest(ACE.Entity.Models.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public Chest(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
        ...
        /// Restore a WorldObject from the database.
        /// </summary>
        public Chest(ACE.Entity.Models.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
