...
namespace ACE.Server.WorldObjects
{
    public sealed class HousePortal : Portal
    {
        ...
        /// </summary>
        public HousePortal(Database.Models.World.Weenie weenie, ObjectGuid guid) : base(weenie, guid)
        {
            SetEphemeralValues();
        }
        ...
        /// </summary>
        public HousePortal(Database.Models.Shard.Biota biota) : base(biota)
        {
            SetEphemeralValues();
        }
