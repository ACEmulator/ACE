...
namespace ACE.Server.Factories
{
    public class LootGenerationFactory
    {
        ...
        public static WorldObject CreateRandomScroll(int tier)
        {
            ...
            //This is commented code to show Ripley's Scroll object.  It does not work as is.
            //Weenie weenie = wDb.GetWeenie(className);
            //ObjectGuid guid = new ObjectGuid();
            //Scroll wo = new Scroll(weenie, guid);
            //Console.WriteLine("Writing a scrool with name : to corpse : " + wo.Name);
            return wo;
        }
