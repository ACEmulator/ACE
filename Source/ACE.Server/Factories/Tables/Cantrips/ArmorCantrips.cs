...
namespace ACE.Server.Factories.Tables
{
    public static class ArmorCantrips
    {
        ...
        {
            ( SpellId.CANTRIPSTRENGTH1,                    0.023f ),
            ( SpellId.CANTRIPENDURANCE1,                   0.023f ),
            ( SpellId.CANTRIPCOORDINATION1,                0.023f ),
            ( SpellId.CANTRIPQUICKNESS1,                   0.023f ),
            ( SpellId.CANTRIPFOCUS1,                       0.023f ),
            ( SpellId.CANTRIPWILLPOWER1,                   0.023f ),

            ( SpellId.CANTRIPHEAVYWEAPONSAPTITUDE1,        0.018f ),
            ( SpellId.CANTRIPLIGHTWEAPONSAPTITUDE1,        0.018f ),
            ( SpellId.CANTRIPFINESSEWEAPONSAPTITUDE1,      0.018f ),
            ( SpellId.CANTRIPMISSILEWEAPONSAPTITUDE1,      0.022f ),
            ( SpellId.CANTRIPTWOHANDEDAPTITUDE1,           0.02f ),

            ( SpellId.CANTRIPIMPREGNABILITY1,              0.027f ),
            ( SpellId.CANTRIPINVULNERABILITY1,             0.027f ),
            ( SpellId.CANTRIPMAGICRESISTANCE1,             0.028f ),

            ( SpellId.CANTRIPCREATUREENCHANTMENTAPTITUDE1, 0.022f ),
            ( SpellId.CANTRIPITEMENCHANTMENTAPTITUDE1,     0.022f ),
            ( SpellId.CANTRIPLIFEMAGICAPTITUDE1,           0.022f ),
            ( SpellId.CANTRIPWARMAGICAPTITUDE1,            0.024f ),
            ( SpellId.CantripVoidMagicAptitude1,           0.024f ),
            ...
            ( SpellId.CANTRIPARMOR1,                       0.024f ),
            ( SpellId.CANTRIPACIDWARD1,                    0.024f ),
            ( SpellId.CANTRIPBLUDGEONINGWARD1,             0.024f ),
            ( SpellId.CANTRIPFLAMEWARD1,                   0.024f ),
            ( SpellId.CANTRIPFROSTWARD1,                   0.024f ),
            ( SpellId.CANTRIPPIERCINGWARD1,                0.024f ),
            ( SpellId.CANTRIPSLASHINGWARD1,                0.024f ),
            ( SpellId.CANTRIPSTORMWARD1,                   0.024f ),

            ( SpellId.CANTRIPALCHEMICALPROWESS1,           0.022f ),
            ( SpellId.CANTRIPARCANEPROWESS1,               0.022f ),
            ( SpellId.CANTRIPARMOREXPERTISE1,              0.022f ),
            ( SpellId.CANTRIPCOOKINGPROWESS1,              0.022f ),
            ( SpellId.CANTRIPDECEPTIONPROWESS1,            0.022f ),
            //( SpellId.CANTRIPFEALTY1,                      0.01f ),
            ( SpellId.CANTRIPFLETCHINGPROWESS1,            0.022f ),
            ( SpellId.CANTRIPHEALINGPROWESS1,              0.022f ),
            ( SpellId.CANTRIPITEMEXPERTISE1,               0.022f ),
            //( SpellId.CANTRIPJUMPINGPROWESS1,              0.01f ),
            //( SpellId.CANTRIPLEADERSHIP1,                  0.01f ),
            ( SpellId.CANTRIPLOCKPICKPROWESS1,             0.022f ),
            ( SpellId.CANTRIPMAGICITEMEXPERTISE1,          0.022f ),
            ( SpellId.CANTRIPMANACONVERSIONPROWESS1,       0.022f ),
            ...
            ( SpellId.CANTRIPWEAPONEXPERTISE1,             0.022f ),

            ( SpellId.CantripDirtyFightingProwess1,        0.016f ),
            ( SpellId.CantripDualWieldAptitude1,           0.016f ),
            ( SpellId.CantripRecklessnessProwess1,         0.016f ),
            ( SpellId.CantripShieldAptitude1,              0.006f ),
