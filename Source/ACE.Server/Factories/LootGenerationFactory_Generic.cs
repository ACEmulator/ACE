...
namespace ACE.Server.Factories
{
    public static partial class LootGenerationFactory
    {
        ...
        {
            uint foodType = 0;
            foodType = (uint)LootTables.food[ThreadSafeRandom.Next(0, LootTables.food.Length - 1)];
