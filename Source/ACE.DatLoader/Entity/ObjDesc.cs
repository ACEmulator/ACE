...
namespace ACE.DatLoader.Entity
{
    public class ObjDesc
    {
        ...
        public static ObjDesc ReadFromDat(ref DatReader datReader)
        {
            ...
            for (var k = 0; k < numTextureMapChanges; k++)
            {
                var texturechange = new TextureMapChange();
            ...
            for (var k = 0; k < numAnimPartChanges; k++)
            {
                var apchange = new AnimationPartChange();
