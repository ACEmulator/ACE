...
namespace ACE.Entity.Adapter
{
    ...
    {
        public static Biota ConvertToBiota(this Weenie weenie, uint id, bool copyEmptyCollections = false)
        {
            ...
            if (weenie.PropertiesBool != null && (copyEmptyCollections || weenie.PropertiesBool.Count > 0))
                result.PropertiesBool = new Dictionary<PropertyBool, bool>(weenie.PropertiesBool);
            if (weenie.PropertiesDID != null && (copyEmptyCollections || weenie.PropertiesDID.Count > 0))
                result.PropertiesDID = new Dictionary<PropertyDataId, uint>(weenie.PropertiesDID);
            if (weenie.PropertiesFloat != null && (copyEmptyCollections || weenie.PropertiesFloat.Count > 0))
                result.PropertiesFloat = new Dictionary<PropertyFloat, double>(weenie.PropertiesFloat);
            if (weenie.PropertiesIID != null && (copyEmptyCollections || weenie.PropertiesIID.Count > 0))
                result.PropertiesIID = new Dictionary<PropertyInstanceId, uint>(weenie.PropertiesIID);
            if (weenie.PropertiesInt != null && (copyEmptyCollections || weenie.PropertiesInt.Count > 0))
                result.PropertiesInt = new Dictionary<PropertyInt, int>(weenie.PropertiesInt);
            if (weenie.PropertiesInt64 != null && (copyEmptyCollections || weenie.PropertiesInt64.Count > 0))
                result.PropertiesInt64 = new Dictionary<PropertyInt64, long>(weenie.PropertiesInt64);
            if (weenie.PropertiesString != null && (copyEmptyCollections || weenie.PropertiesString.Count > 0))
                result.PropertiesString = new Dictionary<PropertyString, string>(weenie.PropertiesString);


            if (weenie.PropertiesPosition != null && (copyEmptyCollections || weenie.PropertiesPosition.Count > 0))
            {
            ...
            if (weenie.PropertiesSpellBook != null && (copyEmptyCollections || weenie.PropertiesSpellBook.Count > 0))
                result.PropertiesSpellBook = new Dictionary<int, float>(weenie.PropertiesSpellBook);


            if (weenie.PropertiesAnimPart != null && (copyEmptyCollections || weenie.PropertiesAnimPart.Count > 0))
            {
            ...
            if (weenie.PropertiesPalette != null && (copyEmptyCollections || weenie.PropertiesPalette.Count > 0))
            {
            ...
            if (weenie.PropertiesTextureMap != null && (copyEmptyCollections || weenie.PropertiesTextureMap.Count > 0))
            {
            ...
            if (weenie.PropertiesCreateList != null && (copyEmptyCollections || weenie.PropertiesCreateList.Count > 0))
            {
            ...
            if (weenie.PropertiesEmote != null && (copyEmptyCollections || weenie.PropertiesEmote.Count > 0))
            {
            ...
            if (weenie.PropertiesEventFilter != null && (copyEmptyCollections || weenie.PropertiesEventFilter.Count > 0))
                result.PropertiesEventFilter = new List<int>(weenie.PropertiesEventFilter);

            if (weenie.PropertiesGenerator != null && (copyEmptyCollections || weenie.PropertiesGenerator.Count > 0))
            {
            ...
            if (weenie.PropertiesAttribute != null && (copyEmptyCollections || weenie.PropertiesAttribute.Count > 0))
            {
            ...
            if (weenie.PropertiesAttribute2nd != null && (copyEmptyCollections || weenie.PropertiesAttribute2nd.Count > 0))
            {
            ...
            if (weenie.PropertiesBodyPart != null && (copyEmptyCollections || weenie.PropertiesBodyPart.Count > 0))
            {
            ...
            if (weenie.PropertiesSkill != null && (copyEmptyCollections || weenie.PropertiesSkill.Count > 0))
            {
            ...
            if (weenie.PropertiesBookPageData != null && (copyEmptyCollections || weenie.PropertiesBookPageData.Count > 0))
