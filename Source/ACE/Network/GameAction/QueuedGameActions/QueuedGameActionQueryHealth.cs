...
namespace ACE.Network.GameAction.QueuedGameActions
{
    ...
    {
        public QueuedGameActionQueryHealth(uint objectId, GameActionType actionType)
        {
            ObjectId = objectId;
        ...
        protected override void Handle(Player player)
        {
            ...
            var obj = LandblockManager.GetWorldObject(player.Session, new ObjectGuid(ObjectId));
