...
namespace ACE.Network.GameEvent.Events
{
    public class GameEventIdentifyObjectResponse : GameEventMessage
    {
        ...
        {
            obj.SerializeIdentifyObjectResponse(this.Writer);
            ...
            ////            session.Network.EnqueueSend(new GameMessageSystemChat($"{DebugOutputString(type, obj)}", ChatMessageType.System));
            ////#endif
        }
