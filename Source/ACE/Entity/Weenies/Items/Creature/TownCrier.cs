...
{
    public class TownCrier : Vendor
    {
        public TownCrier(ObjectType type, ObjectGuid guid, string name, ushort weenieClassId, ObjectDescriptionFlag descriptionFlag, WeenieHeaderFlag weenieFlag, Position position)
            : base(type, guid, name, weenieClassId, descriptionFlag, weenieFlag, position)
        {
        }

        public TownCrier(ObjectGuid guid, BaseAceObject baseAceObject)
        ...
        public TownCrier(AceObject aceO)
        ...
        {
            // TODO: Implement
            string message = "Town criers are available in most major towns to tell you of the latest news and events. We'll also give you a piece of information for a bit of money";
