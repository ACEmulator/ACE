...
{
    public class AcademyGuardExitYaraq : Vendor
    {
        public AcademyGuardExitYaraq(ObjectType type, ObjectGuid guid, string name, ushort weenieClassId, ObjectDescriptionFlag descriptionFlag, WeenieHeaderFlag weenieFlag, Position position)
            : base(type, guid, name, weenieClassId, descriptionFlag, weenieFlag, position)
        {
        }

        public AcademyGuardExitYaraq(ObjectGuid guid, BaseAceObject baseAceObject)
            : base(guid, baseAceObject)
        {
        }

        public AcademyGuardExitYaraq(AceObject aceO)
