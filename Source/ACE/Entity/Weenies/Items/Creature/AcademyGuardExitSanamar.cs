...
{
    public class AcademyGuardExitSanamar : Vendor
    {
        public AcademyGuardExitSanamar(ObjectType type, ObjectGuid guid, string name, ushort weenieClassId, ObjectDescriptionFlag descriptionFlag, WeenieHeaderFlag weenieFlag, Position position)
            : base(type, guid, name, weenieClassId, descriptionFlag, weenieFlag, position)
        {
        }

        public AcademyGuardExitSanamar(ObjectGuid guid, BaseAceObject baseAceObject)
            : base(guid, baseAceObject)
        {
        }

        public AcademyGuardExitSanamar(AceObject aceO)
