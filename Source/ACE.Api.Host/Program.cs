    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            if (!string.IsNullOrWhiteSpace(ConfigManager.Config.ApiServer?.ListenUrl))
            {
                ...
                var url = ConfigManager.Config.ApiServer.ListenUrl;
                bool success = false;
                try
                {
                ...
                {
                    Console.WriteLine($"Failed to start Api.Host due to the following error:");
                ...
                if (success)
                {
                    Console.WriteLine($"ACE API listening at {url}");
                    Console.ReadLine();
                }
                else
                {
                    Console.WriteLine($"ACE API failed to start listening.");
                    Console.ReadLine();
                }
            }
            else
